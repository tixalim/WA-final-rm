...
<?php include_once __DIR__ . '/../partials/navbar.php'; ?>
    ...
    <main class="flex-grow-1">
        <div class="container py-4">
            <h1 class="mb-4">Příspěvky uživatelů</h1>
                <?php if (empty($posts)): ?>
                    <div class="alert alert-info">Zatím zde nejsou žádné příspěvky.</div>
                <?php else: ?>
                        ...
                        <div class="card mb-4 shadow-sm bg-light rounded-4">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="<?= BASE_URL ?>views/posts/detail.php?id=<?= $post['id'] ?>" class="btn btn-outline-success btn-sm">Číst dál</a>
